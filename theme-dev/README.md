...
| transparent | Status bar color in main screens, inactive button of (Emoji/Gif/Stickers) and events (Event info/Interested) button backgrounds
...
| uikit_btn_bg_color_selector_green | Online Icon Color,in 'Invite Members' page invite button outline and text color add friend text colour, live events button background, "Active now"/"live event" text and blob, in Privacy & Safety "Keep me safe" text |
